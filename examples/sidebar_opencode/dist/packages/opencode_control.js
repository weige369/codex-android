...
const opencode_config_runtime_js_1 = require("../shared/opencode_config_runtime.js");
exports.usage_advice = async function usageAdvice() {
    return {
        success: true,
        message: "本包只负责编辑 OpenCode 全局配置文件 ~/.config/opencode/opencode.json，不负责服务启停。",
    };
};
exports.read_opencode_global_config = opencode_config_runtime_js_1.readOpenCodeGlobalConfig;
exports.write_opencode_global_config = opencode_config_runtime_js_1.writeOpenCodeGlobalConfig;
exports.merge_opencode_global_config = opencode_config_runtime_js_1.mergeOpenCodeGlobalConfig;
